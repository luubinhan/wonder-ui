...
const componentLinks: { section: Section; label: string }[] = [
  ...
  { section: 'components/button-group', label: 'Button Group' },
  { section: 'components/input', label: 'Input' },
  { section: 'components/dropdown', label: 'Dropdown' },
  { section: 'components/tooltip', label: 'Tooltip' },
  { section: 'components/card', label: 'Card' },
  { section: 'components/modal', label: 'Modal' },
  { section: 'components/badge', label: 'Badge' },
  { section: 'components/breadcrumb', label: 'Breadcrumb' },
  ...
  { section: 'components/progress-bar', label: 'Progress Bar' },
  { section: 'components/stepper', label: 'Stepper' },
  { section: 'components/tabs', label: 'Tabs' },
  { section: 'components/pagination', label: 'Pagination' },
];
