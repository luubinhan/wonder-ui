  ...
  return (
    <div className="componentPage">
      ...
      <Text size="sm" variant="muted">
        Override these CSS custom properties to customize Heading font sizes and color.
      </Text>
      <CodeBlock language="bash">{`:root {
  --wonder-font-size-2xl: 3rem;
  --wonder-color-text: #1a1a2e;
}`}</CodeBlock>
      <CssVarsTable vars={componentCssVars.heading} />
